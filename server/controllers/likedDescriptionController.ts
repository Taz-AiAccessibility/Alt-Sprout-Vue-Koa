...
//   const { descriptionType, descriptionText, imageAnalysis } = ctx.request.body;
...
//         description_type: descriptionType,
//         description_text: descriptionText,
//         description_origin: imageAnalysis,
//       },
//     ]);
...
//     ctx.status = 500;
//     ctx.body = {
//       error: 'Error saving description',
//       details: error.message || error,
//     };
//   }
// };

// // Get liked descriptions for a user
// export const getLikedDescriptions = async (ctx: Context) => {
//   const userId = ctx.params.userId;
